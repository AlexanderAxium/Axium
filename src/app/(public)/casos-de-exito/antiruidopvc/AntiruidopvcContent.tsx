...
export default function AntiruidopvcContent() {
  const data = useCaseContent("antiruidopvc");
  ...
  return (
    <div className="min-h-screen">
          ...
          <div className="mb-12 lg:mb-16">
            <CaseImages
              images={[
                {
                  src: data.image,
                  alt: "Decibeles — vista principal del sitio",
                },
              ]}
              columns={1}
            />
      ...
      <CaseNextProject excludeSlug="antiruidopvc" />
