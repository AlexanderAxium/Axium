...
export default function EnrafmedicaContent() {
  const data = useCaseContent("enrafmedica");
  ...
  return (
    <div className="min-h-screen">
      <CaseHeroSplit
        ...
        gradient="linear-gradient(180deg, #0a0e14 0%, #0f1729 50%, #152238 100%)"
        blurOrbs={["rgba(0,114,207,0.12)", "rgba(30,80,120,0.1)"]}
      ...
      <CaseNextProject excludeSlug="enrafmedica" />
