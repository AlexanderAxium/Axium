...
export default function PodologiemtkContent() {
  const data = useCaseContent("podologiemtk");
  ...
  return (
    <div className="min-h-screen">
      <CaseHeroSplit
        ...
        gradient="linear-gradient(180deg, #0d1218 0%, #1a2432 50%, #1e2d3d 100%)"
        blurOrbs={["rgba(45,80,95,0.15)", "rgba(60,95,110,0.1)"]}
        ...
        <CaseArticleWide>
          <div className="mb-12 lg:mb-16">
            <CaseImages
              images={[
                {
                  src: "/images/proyects/podologiemtk/podologiemtk-home.jpg",
                  alt: "Podologie MTK — vista principal del sitio",
                },
                {
                  src: "/images/proyects/podologiemtk/podologiemtk-leistungen.jpg",
                  alt: "Podologie MTK — sección de servicios",
                },
              ]}
              columns={2}
              equalHeight
      ...
      <CaseNextProject excludeSlug="podologiemtk" />
